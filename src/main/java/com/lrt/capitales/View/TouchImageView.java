...
public class TouchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    // Mon listener pour clique sur la carte
    private MyOnClickMapListener listener;
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (xDiff < CLICK && yDiff < CLICK)
                            listener.onCliqueMap(
                                    (event.getX()-m[Matrix.MTRANS_X])/saveScale/origWidth,
                                    (event.getY()-m[Matrix.MTRANS_Y])/saveScale/origHeight);
                            performClick();
                        break;
